...
ArrayList<Node> BFS(int[] start, int[] end)
{
...
ArrayList<Node> DFS(int[] start, int[] end)
{
...
ArrayList<Node> Dijkstra(int[] start, int[] end)
{
    Queue<Node> open_list = new LinkedList<Node>();
    ArrayList<Node> closed_list = new ArrayList<Node>();
    ArrayList<Node> path = new ArrayList<Node>();
...
ArrayList<Node> AStar(int[] start, int[] end)
{
